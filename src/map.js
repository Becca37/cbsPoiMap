				...
				(
					{
						...
						markerInfo.classList.remove('isNotVisible');
						markerInfo.classList.add('isVisible');
						// ------------------------------------------------------------------
					}
				);
		}
...
function closeMarkerInfoPanel() {
	try {
		markerInfo.classList.remove('isVisible');
		markerInfo.classList.add('isNotVisible');
	}
	catch (e) {
...
function adjustContentHeight() {
	...
	document.getElementById('markerInfo').setAttribute("style", useContentHeight);
}
